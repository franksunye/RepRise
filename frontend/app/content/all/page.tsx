...
import { BookOpen, FileText, CheckSquare, MessageSquare, Download, Search, Clock, User } from 'lucide-react';
...
export default function AllContentPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">全部内容</h1>
        <p className="text-gray-600 mt-1">浏览与管理内容资源（支持搜索、筛选与多视图）</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>支持卡片与列表两种视图</CardDescription>
        </CardHeader>
        <CardContent>
          {view === 'grid' ? (
