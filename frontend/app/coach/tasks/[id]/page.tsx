...
const mockTasksDetail = [
  ...
  },
  {
    ...
    coachName: '刘教练',
    title: '上门勘查模拟',
    description: '练习现场勘查沟通，提升专业形象。重点关注如何在现场快速诊断问题，并给出专业的解决方案。',
    type: 'on-site',
    dueDate: '2024-11-18',
    status: 'pending',
    priority: 'medium',
  ...
  },
  {
    ...
    coachName: '刘教练',
    title: '报价谈判练习',
    description: '练习报价流程和异议处理技巧。学习如何清晰地解释价值，并有效处理客户的价格异议。',
    type: 'pricing',
    dueDate: '2024-11-22',
    status: 'pending',
    priority: 'high',
  ...
  },
  {
    ...
    coachName: '刘教练',
    title: '异议处理专项训练',
    description: '针对性练习各种客户异议的处理方法。重点关注价格异议、技术异议和竞争对手异议的处理。',
    type: 'objection',
    dueDate: '2024-11-19',
    status: 'pending',
    priority: 'high',
    ...
    relatedActionItemIds: ['action-item-4', 'action-item-5'],
  },
];
