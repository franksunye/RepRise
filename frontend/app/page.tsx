      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Button variant="outline" className="h-24 flex flex-col gap-2 hover:border-blue-500 hover:bg-blue-50">
              <Phone className="h-6 w-6 text-blue-600" />
              <span className="font-medium">电话练习</span>
              <span className="text-xs text-gray-500">首次沟通</span>
            </Button>
            <Button variant="outline" className="h-24 flex flex-col gap-2 hover:border-green-500 hover:bg-green-50">
              <HomeIcon className="h-6 w-6 text-green-600" />
              <span className="font-medium">上门模拟</span>
              <span className="text-xs text-gray-500">勘查场景</span>
            </Button>
            <Button variant="outline" className="h-24 flex flex-col gap-2 hover:border-purple-500 hover:bg-purple-50">
              <DollarSign className="h-6 w-6 text-purple-600" />
              <span className="font-medium">报价练习</span>
              <span className="text-xs text-gray-500">议价谈判</span>
            </Button>
            <Button variant="outline" className="h-24 flex flex-col gap-2 hover:border-orange-500 hover:bg-orange-50">
